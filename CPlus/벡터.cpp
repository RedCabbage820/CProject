...
////	 --> 불가능한건 아니나 비효율적이기에 이런 상황이면 피한다.(속도 오래 걸림)
...
//	//vector<자료형> 벡터명(크기);
//	vector<int> v3(5);
//	//int형 벡터, 저장 크기 = 5개, 기본값 0
//
//	//3. 벡터 생성과 값 초기화
//	//vector<자료형> 벡터명 = {값1, 값2, ... };
//	vector<string> v4 = { "A1", "A2", "A3" };
//	//string형 벡터, 저장 크기 = 3개, 값 : [A1,A2,A3]
//
//	//4. 벡터 계열
//	//vetor<자료형> 벡터명 = { {값1, 값2}, {값1, 값} };
...
//	
//	//벡터에 데이터 추가
//	menu.push_back("기본 김밥");
//	//menu.push_back(1); vector가 srting으로 지정되어 있기 때문에
//	//string 이외의 데이터는 들어갈 수 없습니다.
//	//이런 부분이 STL을 사용하는 이유 중 하나입니다.(타입 안전성)
//	menu.push_back("소고기 김밥");
//	menu.push_back("참치 김밥");
//
//	//값 접근
//	cout << menu[0] << endl; //배열과 동일
//
//	//전체 출력(for문)
//	//벡터명.size()는 현재 벡터의 크기(데이터의 개수)를 return합니다.
...
//
//	//전체 출력(interator)
//	//interator는 STL 자료구조의 데이터를 순차적으로 접근할 수 있는 데이터입니다.
//	//해당 문법을 활용할 경우, STL에서는 문법으로 데이터를 뽑을 수 있어 사용됩니다.
//	
