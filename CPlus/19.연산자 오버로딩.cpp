...
//using namespace std;
//
////1. C++는 클래스 사용의 편의성을 위해서 연산자에 대한 재정의를 진행할 수 있습니다.
////2. C++는 전역 함수, 클래스에 대한 연산자 오버로딩이 가능합니다.
//
////유의사항
////1. 연산자의 기능 그 자체가 변경되지는 않는다.
////2. C++에서 제공하지않는 연산자를 대상으로는 진행할 수 없다.
//
//class Product
//{
//public :
...
//	//함수 뒤에 붙는 const는 이 함수 내에서 멤버에 대한 변경을 할 수 없도록 설정합니다.
