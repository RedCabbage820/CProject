...
//C++ 클래스
//클래스 : 데이터와 함수를 하나로 묶은 사용자 정의 데이터 타입
...
class Seat
{
//private에 적혀있는 변수 또는 함수는 공개되지 않습니다.(외부에서 접근할 수 없습니다.)
private :
	string name;
//public에 적혀있는 변수 또는 함수는 공개됩니다.(외부에서 접근할 수 있습니다.)
public :
	...
	{
		//this->name은 현재 클래스 seat 자신이 가지고 있는 name임을 표현합니다.
		this->name = name;
	}
	string getName()
	{
...
int main()
{
	...
	cout << "김준표님께서 2번자리에 예약하셨습니다." << endl;
	seats[1].setName("김준표");
