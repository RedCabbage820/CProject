...
int main()
{
	...
	//a와 b를 비교했을때 비트가 다른 지점을 1, 같으면 0으로 처리합니다.
	//이 연산 방식은 암호학의 기초로 많이 활용
	//1011
	//1110
	//0101 -> 4 + 1 = 5
	printf("a ^ b = %d\n", c);
	...
	printf("c = %d\n", c);
	//shift 연산
	// a << 2 일 경우 a를 왼쪽으로 비트 2칸 이동합니다. 비트 2칸은 2의 3제곱(4)를 의미하니
	// a * 4로 해석이 가능합니다.
	...
	//2. 프로그램에서 이미지 처리하는 작업(e.g. RGB값 분리 결합 픽셀 값 조작)
	//3. 데이터를 압축하는 작업
	//4. 네트워크 관련 기술()
	//
	//5.
