...
int main()
{
	...
	compare(s1, s2);
	//해당 코드를 실행했을 때, s1과 s2가 서로 같은 값이라면 "같은 값입니다."가 나오도록 함수 compare를 설계하시오.

	//힌트
	//int a = function(1); 이런식으로 나오거나 printf(function(1)); 이런 식으로 나오면 return한수
	//fnction(1); 이런식으로 함수만 적혀있으면 일반 함수(void)입니다.
